...
The main idea is same -- raw reviews from different academic institutions are same, but a marketing department of publishing house chooses blurbs from raw reviews differently. Let's again suppose for the sake of simplicity that the reviews from different institutions contain same number of metaphors *not used* in previous 5 years in the blurbs and same number of metaphors *used* in previous 5 years in the blurbs. The raw material for blurbs is homogeneous and the academics across the institutions are influenced by the blurbs in the same way and same magnitude -- there is no real difference across the institutions neither in mechanism nor in result. But then the marketing department excerpts for blurbs more often the passages with new metaphors from prestigious institutions' academics (e.g. academics working on Ivy League Universities: https://en.wikipedia.org/wiki/Ivy_League). And the department excerpts more often the passages with old metaphors from other academics. The reason for the difference in blurbs is again the strategic selection of the publishing house's marketing department, not the differences in raw reviews.   
...
The root of scenario is the marketing department's expectations of the public credit of different institutions. 
